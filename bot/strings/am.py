...
CATALOG_VIEW_BTN = "🛍 ሙሉ ካታሎግ ይመልከቱ"

# ══════════════════════════════════════════════════════════════
# FLOW GUARD
# ══════════════════════════════════════════════════════════════

ALREADY_ADDING = "⚠️ ምርት እያስገቡ ነዎት። የአሁኑን ደረጃ ያጠናቅቁ ወይም /cancel ይጠቀሙ።"
REMIND_PHOTO = "📸 እባክዎ ፎቶ ይላኩ ለመቀጠል።\n\n(/cancel ለመሰረዝ)"

# ══════════════════════════════════════════════════════════════
# FEEDBACK
# ══════════════════════════════════════════════════════════════

FEEDBACK_PROMPT = "ሃሳብዎን ይንገሩን! ምን ይሰራል፣ ምን አይሰራም፣ ወይም ምን ማከል ትፈልጋላቹ?"
FEEDBACK_THANKS = "ለግብረመልስዎ እናመሰግናለን! ሁሉንም መልዕክት እናነባለን።"
FEEDBACK_NUDGE = "እስካሁን ልምድዎ እንዴት ነው? /feedback በመላክ ሐሳብዎን ያጋሩን።"

# ══════════════════════════════════════════════════════════════
# FREE TIER LIMITS
# ══════════════════════════════════════════════════════════════

WAITLIST_MSG = "በአሁኑ ጊዜ ሙሉ ነን! ቦታ ሲከፈት እናሳውቅዎታለን።"
...
STOCK_CHECK_HEADER = "እነዚህ አሁንም አሉ?"
